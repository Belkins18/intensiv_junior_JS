...
/***/ "./src/js/helpers/getClassName.js":
/*!****************************************!*\
  !*** ./src/js/helpers/getClassName.js ***!
  \****************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getClassName; });
...
/* harmony import */ var _modules_ajax__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/ajax */ "./src/js/modules/ajax.js");
...
/* harmony import */ var _modules_timer_timerSettings__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/timer/timerSettings */ "./src/js/modules/timer/timerSettings.js");
/* harmony import */ var _modules_timer_timer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/timer/timer */ "./src/js/modules/timer/timer.js");
...
var tData = _modules_timer_timerSettings__WEBPACK_IMPORTED_MODULE_5__["default"].init();
...
function descriptionBtn() {
  ...
  info.addEventListener('click', function (evt) {
    ...
    var descBtn = _target.closest('.description-btn');
...
document.addEventListener("DOMContentLoaded", function () {
  _modules_tab__WEBPACK_IMPORTED_MODULE_0__["default"].init();
  modal.init();
  _modules_ajax__WEBPACK_IMPORTED_MODULE_2__["default"].init();
  _modules_slider__WEBPACK_IMPORTED_MODULE_3__["default"].init();
  _modules_calc__WEBPACK_IMPORTED_MODULE_4__["default"].init();
  descriptionBtn();
  _modules_timer_timer__WEBPACK_IMPORTED_MODULE_6__["default"].init(tData);
});
  ...
  init: function init() {
    ...
    form.addEventListener('submit', function (event) {
      ...
      postData(formData).then(function () {
        return statusMessage.innerHTML = massage.loading;
      }).then(function () {
        statusMessage.innerHTML = massage.success;
        setInterval(function () {// eventListeners.modal().popupClose
          // //                     // modalSelectors.popupClose.click();
          // modalSelectors.popupClose.removeEventListener('click', x);
        }, 3000);
      }).catch(function () {
        return statusMessage.innerHTML = massage.failure;
      }).then(clearInput);
    });
    form2.addEventListener('submit', function (event) {
      event.preventDefault();
      form2.appendChild(statusMessage);
      var statusField = this.querySelector('.status');
...
/* harmony default export */ __webpack_exports__["default"] = ({
  init: function init() {
    ...
    persons.addEventListener('change', function () {
      ...
      console.log(_typeof(personsSum));
...
/* harmony import */ var _helpers_getClassName__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/getClassName */ "./src/js/helpers/getClassName.js");
  ...
  _createClass(Modal, [{
    ...
    value: function init() {
      ...
      this.btn.addEventListener('click', function (evt) {
        ...
        var modalBtn = _target.closest(".".concat(Object(_helpers_getClassName__WEBPACK_IMPORTED_MODULE_0__["default"])(_this.btn)));
      ...
      this.popupClose.addEventListener('click', function (evt) {
        evt.preventDefault();
        var _target = evt.target;
        console.log(_target);

        if (!_target.closest(".".concat(Object(_helpers_getClassName__WEBPACK_IMPORTED_MODULE_0__["default"])(_this.popupClose)))) {
          return;
        } else {
          _this.overlay.classList.remove('is-open');

          _this.overlay.classList.remove('fadeOut');
...
/* harmony default export */ __webpack_exports__["default"] = ({
  init: function init() {
    ...
    function hideTabContent(a) {
      for (var i = a; i < infoCnt.length; i++) {
  ...
  init: function init(obj) {
    var t = setInterval(function () {
      var res = {
        ...
        correct: function correct(func) {
          return func < 10 ? "0".concat(func) : func;
        },
        days: function days() {
          return obj.days();
        },
        ...
        minutes: function minutes() {
          return obj.minutes() < 10 ? "0".concat(obj.minutes()) : obj.minutes();
        },
        seconds: function seconds() {
          return obj.seconds() < 10 ? "0".concat(obj.seconds()) : obj.seconds();
        }
      };
      obj.domElements.hours.textContent = "".concat(res.hours());
      obj.domElements.minutes.textContent = "".concat(res.minutes());
      obj.domElements.seconds.textContent = "".concat(res.seconds());
...
/***/ "./src/js/modules/timer/timerSettings.js":
/*!***********************************************!*\
  !*** ./src/js/modules/timer/timerSettings.js ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ({
  init: function init() {
    var timesParam = {
      ...
      getDifferent: function getDifferent() {
        return this.getDownDate() - this.getCurDate();
      },
      getDays: function getDays(ms) {
        return Math.floor(ms / (1000 * 60 * 60 * 24));
      },
      getHours: function getHours(ms) {
        return Math.floor(ms % (1000 * 60 * 60 * 24) / (1000 * 60 * 60));
      },
      getMinutes: function getMinutes(ms) {
        return Math.floor(ms % (1000 * 60 * 60) / (1000 * 60));
      },
      getSeconds: function getSeconds(ms) {
